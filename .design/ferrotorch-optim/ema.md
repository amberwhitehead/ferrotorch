...
| REQ-6 | SHIPPED | impl: `pub fn with_decay_warmup(mut self, use_warmup: bool) -> Self` builder method + `fn effective_decay(&self)` impl in `ema.rs`; non-test consumer: `ferrotorch/src/lib.rs` re-exports the type, making `.with_decay_warmup(true)` reachable. |
