...
- [x] AC-11: Integer comparison constructors `compare_int_basic` at
  `bool_tensor.rs:1064`; CUDA broadcast parity covered by
...
- `ferrotorch-core/src/ops/indexing.rs:1012, :1075, :1165` — kernel-layer
