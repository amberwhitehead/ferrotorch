...
- [ ] AC-10: All 35 `parity_ops` from the route table return `N/N passed
  ...
  **fused-affine + shape subset** of #1344 gained runner arms 2026-05-27
  ...
  `addr` now reaches `48/48 passed (0 skipped, 0 failed)`. With these wired,
  EVERY op in this file that has a runner-arm-able forward is now covered;
  `eig`/`eigvals` BACKWARD stays NOT-STARTED under #1345 (their FORWARDs
  already have runner arms).
