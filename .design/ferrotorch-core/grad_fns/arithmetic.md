...
- REQ-9: `rsub(a, b, *, alpha=1)` — `torch.rsub(input, other, *, alpha=1)`
  ...
  `tools/parity-sweep/runner/src/main.rs:253`.
...
- REQ-12: `floor_divide(a, b)` — `torch.floor_divide(input, other)` floors
  ...
  `tools/parity-sweep/runner/src/main.rs:330` (binary, no kwargs —
...
- REQ-13: `remainder(a, b)` — `torch.remainder(input, other)` returns the
  ...
  `tools/parity-sweep/runner/src/main.rs:297` (binary, no kwargs —
...
- REQ-14: `fmod(a, b)` — `torch.fmod(input, other)` returns the remainder
  ...
  #1199). Runner arm at `tools/parity-sweep/runner/src/main.rs:311`
...
- [x] AC-9: `rsub` parity-sweep at `--seeds 8` returns
  ...
  `tools/parity-sweep/runner/src/main.rs:253`. The forward result matches
...
- [x] AC-13: `remainder` parity-sweep at `--seeds 8` returns
  ...
  runner arm at `tools/parity-sweep/runner/src/main.rs:297`.
- [x] AC-14: `fmod` parity-sweep at `--seeds 8` returns
  ...
  arm at `tools/parity-sweep/runner/src/main.rs:311`.
- [x] AC-12: `floor_divide` parity-sweep at `--seeds 8` returns
  ...
  arm at `tools/parity-sweep/runner/src/main.rs:330`.
...
`methods.rs:176` + `parity-sweep/runner/src/main.rs:330` +
