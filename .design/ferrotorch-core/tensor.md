...
| REQ-6 | SHIPPED | impl: `to_pinned(device)` at `ferrotorch-core/src/tensor.rs:1082`; non-test consumer: `ferrotorch-data::DataLoader` calls this when `pin_memory(true)` is set. |
