...
| REQ-3 | SHIPPED | impl: `cusparse_handle: OnceLock<CusparseHandle>` at `backend_impl.rs:44`, `cusparselt_handle: OnceLock<CusparseLtHandle>` at line 50; lazy methods at lines 78, 95; non-test consumer: the SpMM / 2:4-sparse matmul trait method bodies in the same `impl GpuBackend` block. |
