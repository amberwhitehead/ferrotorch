...
| REQ-12 | NOT-STARTED | blocker #1416 — `expand`, `arg_constraints`, `support`, `validate_args`, `cdf` (requires incomplete gamma), `_natural_params` / `_log_normalizer` (from `gamma.py:36-43, 70-77, 108-119`) not implemented. Cross-cutting with `lib.md` REQ-5 (blocker #1376). |
