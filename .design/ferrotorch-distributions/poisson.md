...
| REQ-11 | NOT-STARTED | blocker #1407 — `ExponentialFamily` machinery (`_natural_params`, `_log_normalizer` in `poisson.py:81-87`), `expand`, `support = constraints.nonnegative_integer` not implemented; cross-cutting with `lib.md` REQ-5 (Distribution-trait-surface blocker #1376). |
