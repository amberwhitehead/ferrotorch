...
| REQ-11 | NOT-STARTED | blocker #1414 — `expand`, `arg_constraints`, `support`, `validate_args`, `_natural_params` / `_log_normalizer` (from `exponential.py:29-33, 60-66, 88-94`) not implemented. Cross-cutting with `lib.md` REQ-5 (blocker #1376). |
