...
| REQ-10 | NOT-STARTED | blocker #1410 — `logits` constructor, N-D batched probs, `expand`, `enumerate_support`, `arg_constraints`, `support`, `mean` / `mode` / `variance` (from `categorical.py:52-54,87-100,105-142,165-171`) not implemented. Cross-cutting with `lib.md` REQ-5 (blocker #1376). |
