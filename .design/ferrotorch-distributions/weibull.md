...
| REQ-13 | NOT-STARTED | blocker #1436 — `expand` (`weibull.py:58-70`), `support = constraints.positive` (`weibull.py:38`), `concentration_reciprocal` cached `1/k` attribute (`weibull.py:47`) not implemented; cross-cutting with `lib.md` REQ-5. |
