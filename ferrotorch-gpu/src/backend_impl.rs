...
impl GpuBackend for CudaBackendImpl {
    ...
    fn div_rounding_f32(
        ...
        let b_buf = Self::unwrap_buffer(b)?;
        let dev = self.device(a.device_ordinal())?;
        let result = crate::kernels::gpu_div_rounding(a_buf, b_buf, rounding_mode, dev)
            .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer(result, a.device_ordinal()))
    }
    ...
    fn div_rounding_f64(
        ...
        let b_buf = Self::unwrap_buffer_f64(b)?;
        let dev = self.device(a.device_ordinal())?;
        let result = crate::kernels::gpu_div_rounding_f64(a_buf, b_buf, rounding_mode, dev)
            .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_f64(result, a.device_ordinal()))
    }
    ...
    fn leaky_relu_f64(
        ...
        let a_buf = Self::unwrap_buffer_f64(a)?;
        let dev = self.device(a.device_ordinal())?;
        let result = crate::kernels::gpu_leaky_relu_f64(a_buf, negative_slope, dev)
            .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_f64(result, a.device_ordinal()))
    }
    ...
    fn leaky_relu_backward_f64(
        ...
        let i_buf = Self::unwrap_buffer_f64(input)?;
        let dev = self.device(grad.device_ordinal())?;
        let result = crate::kernels::gpu_leaky_relu_backward_f64(g_buf, i_buf, negative_slope, dev)
            .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_f64(result, grad.device_ordinal()))
    }
    ...
    fn hardtanh_backward_f64(
        ...
        let i_buf = Self::unwrap_buffer_f64(input)?;
        let dev = self.device(grad.device_ordinal())?;
        let result = crate::kernels::gpu_hardtanh_backward_f64(g_buf, i_buf, min_val, max_val, dev)
            .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_f64(result, grad.device_ordinal()))
    }

    fn hardsigmoid_f64(&self, a: &GpuBufferHandle) -> FerrotorchResult<GpuBufferHandle> {
        let a_buf = Self::unwrap_buffer_f64(a)?;
        let dev = self.device(a.device_ordinal())?;
        let result = crate::kernels::gpu_hardsigmoid_f64(a_buf, dev).map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_f64(result, a.device_ordinal()))
    }
    ...
    fn hardsigmoid_backward_f64(
        ...
        let i_buf = Self::unwrap_buffer_f64(input)?;
        let dev = self.device(grad.device_ordinal())?;
        let result = crate::kernels::gpu_hardsigmoid_backward_f64(g_buf, i_buf, dev)
            .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_f64(result, grad.device_ordinal()))
    }

    fn hardswish_f64(&self, a: &GpuBufferHandle) -> FerrotorchResult<GpuBufferHandle> {
        let a_buf = Self::unwrap_buffer_f64(a)?;
        let dev = self.device(a.device_ordinal())?;
        let result = crate::kernels::gpu_hardswish_f64(a_buf, dev).map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_f64(result, a.device_ordinal()))
    }
    ...
    fn hardswish_backward_f64(
        ...
        let i_buf = Self::unwrap_buffer_f64(input)?;
        let dev = self.device(grad.device_ordinal())?;
        let result = crate::kernels::gpu_hardswish_backward_f64(g_buf, i_buf, dev)
            .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_f64(result, grad.device_ordinal()))
    }

    fn softsign_f64(&self, a: &GpuBufferHandle) -> FerrotorchResult<GpuBufferHandle> {
        let a_buf = Self::unwrap_buffer_f64(a)?;
        let dev = self.device(a.device_ordinal())?;
        let result = crate::kernels::gpu_softsign_f64(a_buf, dev).map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_f64(result, a.device_ordinal()))
    }
    ...
    fn softsign_backward_f64(
        ...
        let i_buf = Self::unwrap_buffer_f64(input)?;
        let dev = self.device(grad.device_ordinal())?;
        let result = crate::kernels::gpu_softsign_backward_f64(g_buf, i_buf, dev)
            .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_f64(result, grad.device_ordinal()))
    }
    ...
    fn prelu_scalar_f64(
        &self,
        input: &GpuBufferHandle,
        alpha: &GpuBufferHandle,
    ) -> FerrotorchResult<GpuBufferHandle> {
        let i_buf = Self::unwrap_buffer_f64(input)?;
        let a_buf = Self::unwrap_buffer_f64(alpha)?;
        let dev = self.device(input.device_ordinal())?;
        let result =
            crate::kernels::gpu_prelu_scalar_f64(i_buf, a_buf, dev).map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_f64(result, input.device_ordinal()))
    }
    ...
    fn prelu_channel_f64(
        ...
        let a_buf = Self::unwrap_buffer_f64(alpha)?;
        let dev = self.device(input.device_ordinal())?;
        let result = crate::kernels::gpu_prelu_channel_f64(i_buf, a_buf, channels, inner, dev)
            .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_f64(result, input.device_ordinal()))
    }
    ...
    fn prelu_scalar_backward_input_f64(
        ...
        let a_buf = Self::unwrap_buffer_f64(alpha)?;
        let dev = self.device(grad.device_ordinal())?;
        let result = crate::kernels::gpu_prelu_scalar_backward_input_f64(g_buf, i_buf, a_buf, dev)
            .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_f64(result, grad.device_ordinal()))
    }
    ...
    fn prelu_channel_backward_input_f64(
        ...
        let a_buf = Self::unwrap_buffer_f64(alpha)?;
        let dev = self.device(grad.device_ordinal())?;
        let result = crate::kernels::gpu_prelu_channel_backward_input_f64(
            g_buf, i_buf, a_buf, channels, inner, dev,
        )
        .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_f64(result, grad.device_ordinal()))
    }
    ...
    fn prelu_scalar_backward_alpha_f64(
        ...
        let i_buf = Self::unwrap_buffer_f64(input)?;
        let dev = self.device(grad.device_ordinal())?;
        let result = crate::kernels::gpu_prelu_scalar_backward_alpha_f64(g_buf, i_buf, dev)
            .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_f64(result, grad.device_ordinal()))
    }
    ...
    fn prelu_channel_backward_alpha_f64(
        ...
        let i_buf = Self::unwrap_buffer_f64(input)?;
        let dev = self.device(grad.device_ordinal())?;
        let result = crate::kernels::gpu_prelu_channel_backward_alpha_f64(
            g_buf, i_buf, channels, inner, dev,
        )
        .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_f64(result, grad.device_ordinal()))
    }
    ...
    fn broadcast_div_rounding_f64(
        ...
        let b_buf = Self::unwrap_buffer_f64(b)?;
        let dev = self.device(a.device_ordinal())?;
        let result = crate::kernels::gpu_broadcast_div_rounding_f64(
            a_buf,
            b_buf,
            a_shape,
            b_shape,
    ...
    fn broadcast_remainder_f64(
        ...
        let b_buf = Self::unwrap_buffer_f64(b)?;
        let dev = self.device(a.device_ordinal())?;
        let result = crate::kernels::gpu_broadcast_remainder_f64(
            a_buf, b_buf, a_shape, b_shape, out_shape, dev,
        )
        .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_f64(result, a.device_ordinal()))
    }
    ...
    fn broadcast_fmod_f64(
        ...
        let dev = self.device(a.device_ordinal())?;
        let result =
            crate::kernels::gpu_broadcast_fmod_f64(a_buf, b_buf, a_shape, b_shape, out_shape, dev)
                .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_f64(result, a.device_ordinal()))
    }
    ...
    fn broadcast_maximum_f64(
        ...
        let b_buf = Self::unwrap_buffer_f64(b)?;
        let dev = self.device(a.device_ordinal())?;
        let result = crate::kernels::gpu_broadcast_maximum_f64(
            a_buf, b_buf, a_shape, b_shape, out_shape, dev,
        )
        .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_f64(result, a.device_ordinal()))
    ...
    fn broadcast_minimum_f64(
        ...
        let b_buf = Self::unwrap_buffer_f64(b)?;
        let dev = self.device(a.device_ordinal())?;
        let result = crate::kernels::gpu_broadcast_minimum_f64(
            a_buf, b_buf, a_shape, b_shape, out_shape, dev,
        )
        .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_f64(result, a.device_ordinal()))
    ...
    fn broadcast_div_rounding_f32(
        ...
        let b_buf = Self::unwrap_buffer(b)?;
        let dev = self.device(a.device_ordinal())?;
        let result = crate::kernels::gpu_broadcast_div_rounding(
            a_buf,
            b_buf,
            a_shape,
            b_shape,
    ...
    fn broadcast_remainder_f32(
        ...
        let dev = self.device(a.device_ordinal())?;
        let result =
            crate::kernels::gpu_broadcast_remainder(a_buf, b_buf, a_shape, b_shape, out_shape, dev)
                .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer(result, a.device_ordinal()))
    }
    ...
    fn broadcast_fmod_f32(
        ...
        let dev = self.device(a.device_ordinal())?;
        let result =
            crate::kernels::gpu_broadcast_fmod(a_buf, b_buf, a_shape, b_shape, out_shape, dev)
                .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer(result, a.device_ordinal()))
    }
    ...
    fn broadcast_maximum_f32(
        ...
        let dev = self.device(a.device_ordinal())?;
        let result =
            crate::kernels::gpu_broadcast_maximum(a_buf, b_buf, a_shape, b_shape, out_shape, dev)
                .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer(result, a.device_ordinal()))
    }
    ...
    fn broadcast_minimum_f32(
        ...
        let dev = self.device(a.device_ordinal())?;
        let result =
            crate::kernels::gpu_broadcast_minimum(a_buf, b_buf, a_shape, b_shape, out_shape, dev)
                .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer(result, a.device_ordinal()))
    }
    ...
    fn logcumsumexp_backward_f32(
        ...
        let grad_buf = Self::unwrap_buffer(grad_output)?;
        let dev = self.device(input.device_ordinal())?;
        let out = crate::cumulative_kernels::gpu_logcumsumexp_backward_f32(
            input_buf, result_buf, grad_buf, outer, dim_size, inner, dev,
        )
        .map_err(Self::map_gpu_err)?;
    ...
    fn logcumsumexp_backward_f64(
        ...
        let grad_buf = Self::unwrap_buffer_f64(grad_output)?;
        let dev = self.device(input.device_ordinal())?;
        let out = crate::cumulative_kernels::gpu_logcumsumexp_backward_f64(
            input_buf, result_buf, grad_buf, outer, dim_size, inner, dev,
        )
        .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_f64(out, input.device_ordinal()))
    ...
    fn logcumsumexp_backward_f16(
        ...
        let grad_buf = Self::unwrap_buffer_f16(grad_output)?;
        let dev = self.device(input.device_ordinal())?;
        let out = crate::cumulative_kernels::gpu_logcumsumexp_backward_f16(
            input_buf, result_buf, grad_buf, outer, dim_size, inner, dev,
        )
        .map_err(Self::map_gpu_err)?;
    ...
    fn logcumsumexp_backward_bf16(
        ...
        let grad_buf = Self::unwrap_buffer_bf16(grad_output)?;
        let dev = self.device(input.device_ordinal())?;
        let out = crate::cumulative_kernels::gpu_logcumsumexp_backward_bf16(
            input_buf, result_buf, grad_buf, outer, dim_size, inner, dev,
        )
        .map_err(Self::map_gpu_err)?;
    ...
    fn leaky_relu_f32(
        ...
        let a_buf = Self::unwrap_buffer(a)?;
        let dev = self.device(a.device_ordinal())?;
        let result = crate::kernels::gpu_leaky_relu(a_buf, negative_slope, dev)
            .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer(result, a.device_ordinal()))
    }
    ...
    fn leaky_relu_backward_f32(
        ...
        let i_buf = Self::unwrap_buffer(input)?;
        let dev = self.device(grad.device_ordinal())?;
        let result = crate::kernels::gpu_leaky_relu_backward(g_buf, i_buf, negative_slope, dev)
            .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer(result, grad.device_ordinal()))
    }
    ...
    fn hardtanh_backward_f32(
        ...
        let i_buf = Self::unwrap_buffer(input)?;
        let dev = self.device(grad.device_ordinal())?;
        let result = crate::kernels::gpu_hardtanh_backward(g_buf, i_buf, min_val, max_val, dev)
            .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer(result, grad.device_ordinal()))
    }

    fn hardsigmoid_f32(&self, a: &GpuBufferHandle) -> FerrotorchResult<GpuBufferHandle> {
        let a_buf = Self::unwrap_buffer(a)?;
        let dev = self.device(a.device_ordinal())?;
        let result = crate::kernels::gpu_hardsigmoid(a_buf, dev).map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer(result, a.device_ordinal()))
    }
    ...
    fn hardsigmoid_backward_f32(
        ...
        let i_buf = Self::unwrap_buffer(input)?;
        let dev = self.device(grad.device_ordinal())?;
        let result = crate::kernels::gpu_hardsigmoid_backward(g_buf, i_buf, dev)
            .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer(result, grad.device_ordinal()))
    }

    fn hardswish_f32(&self, a: &GpuBufferHandle) -> FerrotorchResult<GpuBufferHandle> {
        let a_buf = Self::unwrap_buffer(a)?;
        let dev = self.device(a.device_ordinal())?;
        let result = crate::kernels::gpu_hardswish(a_buf, dev).map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer(result, a.device_ordinal()))
    }
    ...
    fn hardswish_backward_f32(
        ...
        let dev = self.device(grad.device_ordinal())?;
        let result =
            crate::kernels::gpu_hardswish_backward(g_buf, i_buf, dev).map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer(result, grad.device_ordinal()))
    }

    fn softsign_f32(&self, a: &GpuBufferHandle) -> FerrotorchResult<GpuBufferHandle> {
        let a_buf = Self::unwrap_buffer(a)?;
        let dev = self.device(a.device_ordinal())?;
        let result = crate::kernels::gpu_softsign(a_buf, dev).map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer(result, a.device_ordinal()))
    }
    ...
    fn softsign_backward_f32(
        ...
        let dev = self.device(grad.device_ordinal())?;
        let result =
            crate::kernels::gpu_softsign_backward(g_buf, i_buf, dev).map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer(result, grad.device_ordinal()))
    }
    ...
    fn prelu_scalar_f32(
        ...
        let i_buf = Self::unwrap_buffer(input)?;
        let a_buf = Self::unwrap_buffer(alpha)?;
        let dev = self.device(input.device_ordinal())?;
        let result =
            crate::kernels::gpu_prelu_scalar(i_buf, a_buf, dev).map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer(result, input.device_ordinal()))
    }
    ...
    fn prelu_channel_f32(
        ...
        let a_buf = Self::unwrap_buffer(alpha)?;
        let dev = self.device(input.device_ordinal())?;
        let result = crate::kernels::gpu_prelu_channel(i_buf, a_buf, channels, inner, dev)
            .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer(result, input.device_ordinal()))
    }
    ...
    fn prelu_scalar_backward_input_f32(
        ...
        let a_buf = Self::unwrap_buffer(alpha)?;
        let dev = self.device(grad.device_ordinal())?;
        let result = crate::kernels::gpu_prelu_scalar_backward_input(g_buf, i_buf, a_buf, dev)
            .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer(result, grad.device_ordinal()))
    }
    ...
    fn prelu_channel_backward_input_f32(
        ...
        let a_buf = Self::unwrap_buffer(alpha)?;
        let dev = self.device(grad.device_ordinal())?;
        let result = crate::kernels::gpu_prelu_channel_backward_input(
            g_buf, i_buf, a_buf, channels, inner, dev,
        )
        .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer(result, grad.device_ordinal()))
    ...
    fn prelu_scalar_backward_alpha_f32(
        ...
        let i_buf = Self::unwrap_buffer(input)?;
        let dev = self.device(grad.device_ordinal())?;
        let result = crate::kernels::gpu_prelu_scalar_backward_alpha(g_buf, i_buf, dev)
            .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer(result, grad.device_ordinal()))
    }
    ...
    fn prelu_channel_backward_alpha_f32(
        ...
        let dev = self.device(grad.device_ordinal())?;
        let result =
            crate::kernels::gpu_prelu_channel_backward_alpha(g_buf, i_buf, channels, inner, dev)
                .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer(result, grad.device_ordinal()))
    }
    ...
    fn lu_factor_f32(
        ...
        Ok((
            Self::wrap_buffer(lu, a.device_ordinal()),
            Self::wrap_buffer_i32(ipiv, a.device_ordinal()),
        ))
    }
    ...
    fn broadcast_div_rounding_bf16(
        ...
        let b_buf = Self::unwrap_buffer_bf16(b)?;
        let dev = self.device(a.device_ordinal())?;
        let result = crate::bf16::gpu_broadcast_div_rounding_bf16(
            a_buf,
            b_buf,
            a_shape,
            b_shape,
    ...
    fn broadcast_remainder_bf16(
        ...
        let b_buf = Self::unwrap_buffer_bf16(b)?;
        let dev = self.device(a.device_ordinal())?;
        let result = crate::bf16::gpu_broadcast_remainder_bf16(
            a_buf, b_buf, a_shape, b_shape, out_shape, dev,
        )
        .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_bf16(result, a.device_ordinal()))
    ...
    fn broadcast_fmod_bf16(
        ...
        let dev = self.device(a.device_ordinal())?;
        let result =
            crate::bf16::gpu_broadcast_fmod_bf16(a_buf, b_buf, a_shape, b_shape, out_shape, dev)
                .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_bf16(result, a.device_ordinal()))
    }
    ...
    fn broadcast_maximum_bf16(
        ...
        let dev = self.device(a.device_ordinal())?;
        let result =
            crate::bf16::gpu_broadcast_maximum_bf16(a_buf, b_buf, a_shape, b_shape, out_shape, dev)
                .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_bf16(result, a.device_ordinal()))
    }
    ...
    fn broadcast_minimum_bf16(
        ...
        let dev = self.device(a.device_ordinal())?;
        let result =
            crate::bf16::gpu_broadcast_minimum_bf16(a_buf, b_buf, a_shape, b_shape, out_shape, dev)
                .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_bf16(result, a.device_ordinal()))
    }
    ...
    fn broadcast_div_rounding_f16(
        ...
        let b_buf = Self::unwrap_buffer_f16(b)?;
        let dev = self.device(a.device_ordinal())?;
        let result = crate::f16::gpu_broadcast_div_rounding_f16(
            a_buf,
            b_buf,
            a_shape,
            b_shape,
    ...
    fn broadcast_remainder_f16(
        ...
        let dev = self.device(a.device_ordinal())?;
        let result =
            crate::f16::gpu_broadcast_remainder_f16(a_buf, b_buf, a_shape, b_shape, out_shape, dev)
                .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_f16(result, a.device_ordinal()))
    }
    ...
    fn broadcast_fmod_f16(
        ...
        let dev = self.device(a.device_ordinal())?;
        let result =
            crate::f16::gpu_broadcast_fmod_f16(a_buf, b_buf, a_shape, b_shape, out_shape, dev)
                .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_f16(result, a.device_ordinal()))
    }
    ...
    fn broadcast_maximum_f16(
        ...
        let dev = self.device(a.device_ordinal())?;
        let result =
            crate::f16::gpu_broadcast_maximum_f16(a_buf, b_buf, a_shape, b_shape, out_shape, dev)
                .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_f16(result, a.device_ordinal()))
    }
    ...
    fn broadcast_minimum_f16(
        ...
        let dev = self.device(a.device_ordinal())?;
        let result =
            crate::f16::gpu_broadcast_minimum_f16(a_buf, b_buf, a_shape, b_shape, out_shape, dev)
                .map_err(Self::map_gpu_err)?;
        Ok(Self::wrap_buffer_f16(result, a.device_ordinal()))
    }
    ...
    fn unique_consecutive_1d(
        ...
        match input.dtype() {
            ...
            DType::F16 => {
                let (values, inverse, counts) = crate::search::gpu_unique_consecutive_f16(
                    Self::unwrap_buffer_f16(input)?,
                    n,
                    dev,
                )
            ...
            DType::BF16 => {
                let (values, inverse, counts) = crate::search::gpu_unique_consecutive_bf16(
                    Self::unwrap_buffer_bf16(input)?,
                    n,
                    dev,
                )
    ...
    fn scatter_nd_f16(
        ...
        let dev = self.device(input.device_ordinal())?;
        let ord = input.device_ordinal();
        let out = crate::scatter_gather_kernels::gpu_scatter_nd_u16(
            Self::unwrap_buffer_f16(input)?,
            Self::unwrap_buffer_i64(index)?.inner(),
            Self::unwrap_buffer_f16(src)?,
            input_shape,
    ...
    fn scatter_value_nd_f16(
        ...
        let dev = self.device(input.device_ordinal())?;
        let ord = input.device_ordinal();
        let value_bits = half::f16::from_f32(value).to_bits();
        let out = crate::scatter_gather_kernels::gpu_scatter_value_nd_u16(
            Self::unwrap_buffer_f16(input)?,
            Self::unwrap_buffer_i64(index)?.inner(),
            value_bits,
            input_shape,
    ...
    fn scatter_value_nd_bf16(
        ...
        let dev = self.device(input.device_ordinal())?;
        let ord = input.device_ordinal();
        let value_bits = half::bf16::from_f32(value).to_bits();
        let out = crate::scatter_gather_kernels::gpu_scatter_value_nd_u16(
            Self::unwrap_buffer_bf16(input)?,
            Self::unwrap_buffer_i64(index)?.inner(),
            value_bits,
    ...
    fn scatter_add_nd_f16(
        ...
        let dev = self.device(input.device_ordinal())?;
        let ord = input.device_ordinal();
        let out = crate::scatter_gather_kernels::gpu_scatter_add_nd_f16(
            Self::unwrap_buffer_f16(input)?,
            Self::unwrap_buffer_i64(index)?.inner(),
            Self::unwrap_buffer_f16(src)?,
            input_shape,
    ...
    fn scatter_add_nd_bf16(
        ...
        let dev = self.device(input.device_ordinal())?;
        let ord = input.device_ordinal();
        let out = crate::scatter_gather_kernels::gpu_scatter_add_nd_bf16(
            Self::unwrap_buffer_bf16(input)?,
            Self::unwrap_buffer_i64(index)?.inner(),
            Self::unwrap_buffer_bf16(src)?,
            input_shape,
