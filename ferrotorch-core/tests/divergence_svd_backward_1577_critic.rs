...
fn svd_backward_u_only_square_3x3_matches_torch() {
    ...
    let torch = [
        0.029328629434962557,
        -0.0363669197957946,
        -0.004298238590405856,
        -0.07008240645441464,
        -0.02394609269870782,
        -0.02574434665386807,
        -0.02179163753115973,
        -0.04517849775103137,
        -0.006725977199824413,
    ];
...
fn svd_backward_u_only_tall_4x3_matches_torch() {
    ...
    let torch = [
        0.10487491466826758,
        -0.050713429097242725,
        -0.030740342581945464,
        -0.1535357612428205,
        -0.019278319606425554,
        -0.15765724772379358,
        -0.05959266551900041,
        -0.18256232012065507,
        -0.11136503821712838,
        0.058257840578831925,
        -0.13614838655612158,
        0.07442734097722879,
    ];
...
fn svd_backward_v_only_wide_3x4_matches_torch() {
    ...
    let torch = [
        ...
        -0.2743774079847026,
        -0.07868321403099147,
        0.012127584327848455,
        -0.14266064499916262,
        -0.006401972350948143,
        -0.4549763965330436,
        -0.16687558893553028,
        0.031093203089195262,
        -0.3281229372812002,
        -0.17821254169683234,
        -0.033010034620775904,
    ];
