...
- **GGUF** -- `load_gguf`, `load_gguf_mmap`, `parse_gguf_bytes`, `dequantize_gguf_tensor`, `load_gguf_state_dict` for loading GGUF-quantized models (Q4_0, Q4_1, Q5_0, Q5_1, Q8_0, Q8_1, F16, F32)
...
- **PyTorch export** -- `save_pytorch`, `validate_checkpoint` for writing PyTorch-compatible `.pt` files
