...
pub use keypoint_rcnn::{
    KEYPOINT_RCNN_NUM_CLASSES, KEYPOINT_RCNN_NUM_KEYPOINTS, KeypointDetections, KeypointHead,
    KeypointPredictor, KeypointRcnn, keypointrcnn_resnet50_fpn,
};
